...
public class NoteManager : MonoBehaviour
{
	...
	public void CreateNoteFromData(LoadedNoteData noteData)
	{
		...
		{
			case NoteType.Short:
				noteSpawnData = new ShortNoteSpawnData(shortNotePrefab, hitSound, spawnDspTime, noteData.time);
				break;
			case NoteType.Long:
				noteSpawnData = new LongNoteSpawnData(longNotePrefab, hitSound, spawnDspTime, noteData.time, noteData.endTime);
				break;
		}
